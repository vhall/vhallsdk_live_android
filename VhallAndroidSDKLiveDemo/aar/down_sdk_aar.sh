...
names=(
'library/vh-saas-interactive/6.10.0/vh-saas-interactive-6.10.0.aar'
'library/vh-saas-sdk/6.10.0/vh-saas-sdk-6.10.0.aar'
'library/vhallyun-framework/2.4.4/vhallyun-framework-2.4.4.aar'
'base/http-client/1.1.1/http-client-1.1.1.aar'
'base/logmanager/2.4.9/logmanager-2.4.9.aar'
'base/message-client/1.2.3/message-client-1.2.3.aar'
'base/vhall-beautify-lib/1.1.5/vhall-beautify-lib-1.1.5.aar'
'library/vhallyun-ims/1/vhallyun-ims-2.4.0.aar'
'library/vhallyun-vod/2.5.3/vhallyun-vod-2.5.3.2.aar'
'library/vhallyun-ops/2.5.0/vhallyun-ops-2.6.1.aar'
'base/vhall-module-document/2.2.0/vhall-module-document-2.2.1.aar'
'library/vhallyun-ilss/2.5.4/vhallyun-ilss-2.8.1.6.aar'
'base/vhall-module-rtc/2.3.6/vhall-module-rtc-2.4.2.3.aar'
'base/vhall-module-rtc-so/3.4.1/vhall-module-rtc-so-3.5.0.2.aar'
'library/vhallyun-lss/2.7.2/vhallyun-lss-2.7.2.aar'
