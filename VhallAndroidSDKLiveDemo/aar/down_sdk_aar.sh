...
names=(
'library/vh-saas-interactive/6.7.0/vh-saas-interactive-6.7.0.aar'
'library/vh-saas-sdk/6.7.0/vh-saas-sdk-6.7.0.aar'
...
'library/vhallyun-ilss/2.5.4/vhallyun-ilss-2.8.1.1.aar'
'base/vhall-module-rtc/2.3.6/vhall-module-rtc-2.4.2.aar'
'base/vhall-module-rtc-so/3.4.1/vhall-module-rtc-so-3.5.0.aar'
