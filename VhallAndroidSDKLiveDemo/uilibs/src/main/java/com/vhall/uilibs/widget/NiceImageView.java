...
public class NiceImageView extends AppCompatImageView {
    ...
    public NiceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.NiceImageView_border_width_v) {
                borderWidth = ta.getDimensionPixelSize(attr, borderWidth);
            } else if (attr == R.styleable.NiceImageView_border_color_v) {
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = DensityUtils.dpToPxInt(context, borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = DensityUtils.dpToPxInt(context, innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = DensityUtils.dpToPxInt(context, cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = DensityUtils.dpToPxInt(context, cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = DensityUtils.dpToPxInt(context, cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = DensityUtils.dpToPxInt(context, cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = DensityUtils.dpToPxInt(context, cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
