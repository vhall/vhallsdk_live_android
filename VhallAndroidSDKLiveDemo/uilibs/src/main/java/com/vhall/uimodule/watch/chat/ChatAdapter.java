        ...
        if (msgInfo != null) {
            ...
            switch (msgInfo.event) {
                ...
                case MessageServer.EVENT_PUSH_SCREEN_CRAD://结束抽奖
                    ...
                    VhClickSpan cardspan = new VhClickSpan(mContext.getResources().getColor(R.color.color_3562FA), false) {
                        @Override
                        public void onClick(View widget) {
                            CardDialog dialog = new CardDialog(mContext,msgInfo.cardInfo);
                            dialog.loadCardInfo();
                        }
                    };
